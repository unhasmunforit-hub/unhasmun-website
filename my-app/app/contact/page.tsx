                    ...
                    <div className="lg:col-span-5 pt-4">
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                {/* LinkedIn */}
                                <a href="https://linkedin.com/company/unhasmun" className="w-12 h-12 md:w-16 md:h-16 bg-[#B93636] rounded-xl md:rounded-2xl flex items-center justify-center hover:-translate-y-1 transition-transform shadow-lg">
                                ...
                                {/* Instagram */}
                                <a href="https://instagram.com/unhasmun" className="w-12 h-12 md:w-16 md:h-16 bg-[#B93636] rounded-xl md:rounded-2xl flex items-center justify-center hover:-translate-y-1 transition-transform shadow-lg">
                                    <svg className="w-6 h-6 md:w-8 md:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
