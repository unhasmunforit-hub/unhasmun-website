                    ...
                    <div className="lg:col-span-5 pt-4">
                        ...
                        <div className="space-y-6 my-8 lg:my-12">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 md:w-16 md:h-16 bg-[#B93636] rounded-full flex items-center justify-center shrink-0 shadow-sm border border-white">
                                ...
                                <div>
                                    ...
                                    <p className="text-mun-dark/80 font-medium text-base lg:text-xl">unhasmuncom@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-bold text-mun-dark text-lg lg:text-xl">Contact</h3>
                                    <p className="text-mun-dark/80 font-medium text-base lg:text-xl">+62 882-0212-52641</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                {/* LinkedIn */}
                                <a href="https://www.linkedin.com/in/unhas-model-united-nations-183a40217/" className="w-12 h-12 md:w-16 md:h-16 bg-[#B93636] rounded-xl md:rounded-2xl flex items-center justify-center hover:-translate-y-1 transition-transform shadow-lg">
                                ...
                                {/* Instagram */}
                                <a href="https://www.instagram.com/unhasmun?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="w-12 h-12 md:w-16 md:h-16 bg-[#B93636] rounded-xl md:rounded-2xl flex items-center justify-center hover:-translate-y-1 transition-transform shadow-lg">
                                    <svg className="w-6 h-6 md:w-8 md:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                {/* TikTok */}
                                <a href="https://tiktok.com/@unhasmun" className="w-12 h-12 md:w-16 md:h-16 bg-[#B93636] rounded-xl md:rounded-2xl flex items-center justify-center hover:-translate-y-1 transition-transform shadow-lg">
                                    <svg className="w-6 h-6 md:w-8 md:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
