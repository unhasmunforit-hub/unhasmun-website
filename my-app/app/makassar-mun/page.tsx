...
const committeeDetails: CommitteeInfo[] = [
    {
        ...
        topicDescription:
            "Establishing International Standards for Digital Archiving of Traditional Cultural Expressions to Prevent Misappropriation under the WIPO Framework.. Brace yourselves for a deeply urgent and thought-provoking debate, because the digital era waits for no one. This spectacular topic directly confronts the modern paradox of cultural preservation: while global digital access can immortalize Traditional Cultural Expressions (TCEs), it simultaneously opens the floodgates to rampant cultural misappropriation and commercial theft. Resonating powerfully with the epic spirit of I La Galigo, this agenda demands that delegates forge a balanced consensus on how we safely digitize humanity’s most sacred heritages. The clock is ticking, intangible cultural legacies are rapidly fading in the face of unchecked globalization, making it absolutely critical for us to establish ironclad international standards that protect the rightful cultural owners while navigating the boundless, fast-paced digital landscape.",
    },
    {
        name: "UNHRC",
